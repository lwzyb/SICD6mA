...
class SICResultFrame ( wx.Dialog):
    def __init__( self, parent,result ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Prediction Result", pos = wx.DefaultPosition, size = wx.Size( 817,641 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
        ...
        self.m_staticText2 = wx.StaticText( self.m_panel1, wx.ID_ANY, u"Result of 6mA sites prediction", wx.DefaultPosition, wx.Size( 800,45 ), wx.ALIGN_CENTRE )
        ...
        self.m_panel3.SetFont( wx.Font( 14, 70, 90, 90, False, "Arial" ) )
        ...
        self.m_bt_export.SetFont( wx.Font( 12, 70, 90, 90, False, "Arial" ) )
